...
Как правило, для реализации тестов необходимы:

- набор тестовых сценацриев, которые копируют сценарии использования и определяют функциональность приложения; 
- набор тестовых данных (дамп), конкретные значения на основе которых оценивается правильность выполнения тестов.


Документ содержит общие сведения о конфигурации тестовой среды, описание основных действий для разрабоки тестов и вариантов их запуска, в зависимости от сервиса (СЕРП, Мультимедия  ?).
